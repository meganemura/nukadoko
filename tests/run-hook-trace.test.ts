...
// Responsibility: end-to-end coverage — cutting the Playwright trace into
// one chunk per step silently stopped recording anything a
// Before/After/AfterStep hook did through `ctx.page()`/`this.openPage()`.
