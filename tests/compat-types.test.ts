...
// real-world repos each (compat-audit synthesis), so glue written
...
describe("compat/index.ts type exports (compat-audit: IWorldOptions/ITestCaseHookParameter, 2/2 repos each)", () => {
