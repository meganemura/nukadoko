...
// tests/tend.test.ts's fixture: one project carrying all five m8a-tend-
// command findings at once, each paired with a healthy step exercising the
// same mechanism so a false positive on the healthy step would fail the
// test just as loudly as a missed finding on the unhealthy one.
//
