...
// three keyword aliases (m2a-compat-registry task spec: "Given/When/Then
// ... 全部同じ登録関数の別名"), one file registering three compat steps at
// once — unlike a typed step, compat identity is the pattern, not the file
// (tests/compat-discover.test.ts, tests/compat-cli.test.ts).
