...
// task's spec, item 6: "compat の string pattern に named capture 構文は要
// 求しない") — this is plain, unmodified cucumber-expressions syntax.
...
// task's spec, item 6: "compat pattern も undefined-step 判定に参加").
