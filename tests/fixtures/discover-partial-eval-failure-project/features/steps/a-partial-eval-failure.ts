...
// takes (it throws during evaluation, not at ESM's earlier link phase). A
// plain synchronous `throw` after a real registration reproduces the same
// "partial registration, then a failure" shape without this fixture needing
// an actual CJS dependency.
...
// for discarding the buffer on a caught import failure can rely on this
// file being the *first* one discovery imports.
