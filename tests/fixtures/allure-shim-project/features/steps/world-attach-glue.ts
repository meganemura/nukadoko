...
// Proves item 4: the World channel (`this.attach`/`log`/`link`, previously
// held but unread) now routes to the same declared collector the allure
// facade itself writes into.
