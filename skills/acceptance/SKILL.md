---
name: nukadoko-acceptance
description: Use when handed a ticket or story's acceptance criteria and asked to turn them into a Gherkin scenario, run it, and leave a signed-off record of that run.
---
...
3. `nuka do <step> --args '<json>'` — exercise it alone, check the receipt,
   before it ever touches a feature.
