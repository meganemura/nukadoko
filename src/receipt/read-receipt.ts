...
// shape (that task's spec, decision 12: this exact shape was the choice
// made). write-receipt.ts's
...
// decision 12's own text: an unreadable receipt is treated as null and the
// mapping continues), so every read failure — file not found, malformed JSON, any other
