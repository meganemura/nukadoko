...
// never touches `errors`/`notes`, never affects
...
// here counts at all — the one number that is genuinely new, since naming
// the migration breakdown is the only thing this summary line adds.
//
// `scannedFeatureDirs` is simply
...
// is counted in the same loop that already
